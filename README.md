...
26. Select all the files that have changed and type a message in the text box as shown in the image. The message should summarize the work done then, and click the commit and push button.<p/><image src="./step31.png" height="400"></p>
